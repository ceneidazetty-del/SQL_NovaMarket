...
> [!TIP]
> **¿Quieres entender el código?** Revisa la guía **[03_Detalle_Codigo_Python.md](file:///c:/Users/Asus/Downloads/SQL_NovaMarket-main/SQL_NovaMarket-main/02_Sesion_07/03_Detalle_Codigo_Python.md)** para ver la explicación paso a paso de lo que hace Python con tus datos.
...
2.  Crea una **Nueva Conexión** (Add New Connection).
    ...
    - **Database File:** **NO** uses el buscador. Copia y pega la ruta completa:
      `C:\Users\Asus\Downloads\SQL_NovaMarket-main\SQL_NovaMarket-main\02_Sesion_07\Novamarket_S07.db`
