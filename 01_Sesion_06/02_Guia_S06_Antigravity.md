...
2.  **Ubicación en Terminal:** Abre tu terminal integrada (`Ctrl + ñ` o `Cmd + J`) y asegúrate de estar en la carpeta correcta:
    ```bash
    cd C:\Users\Asus\Downloads\SQL_NovaMarket-main\SQL_NovaMarket-main\01_Sesion_06
    ```
...
4.  Configura así:
    ...
    *   **Database file:** `C:\Users\Asus\Downloads\SQL_NovaMarket-main\SQL_NovaMarket-main\01_Sesion_06\01_Base_Datos_S06.db`
...
👉 **Siguiente Sesión:** [05_Puente_S07.md](file:///c:/Users/Asus/Downloads/SQL_NovaMarket-main/SQL_NovaMarket-main/01_Sesion_06/05_Puente_S07.md)
